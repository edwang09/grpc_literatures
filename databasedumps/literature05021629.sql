...
--
-- Host: mysql_db1
-- Generation Time: May 02, 2021 at 08:29 PM
...
--
ALTER TABLE `author_grant`
  MODIFY `author_grant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `book_format`
  MODIFY `book_format_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `book_grant`
--
ALTER TABLE `book_grant`
  MODIFY `book_grant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `book_format`
  ADD CONSTRAINT `book_format_ibfk_1` FOREIGN KEY (`book_id`) REFERENCES `book` (`book_id`) ON DELETE CASCADE ON UPDATE CASCADE;
